...
export const PRELOADED_FOODS: FoodResult[] = [
  ...
  { name: "Leche entera Lala", carbsPer100g: 5, source: "local", category: "Lácteos", unit: "ml" },
  { name: "Leche entera Nutri Yaki", carbsPer100g: 5, source: "local", category: "Lácteos", unit: "ml" },
  { name: "Leche descremada Lala", carbsPer100g: 5, source: "local", category: "Lácteos", unit: "ml" },
  { name: "Leche entera Alpura", carbsPer100g: 5, source: "local", category: "Lácteos", unit: "ml" },
  { name: "Leche de chocolate Lala", carbsPer100g: 10, source: "local", category: "Lácteos", unit: "ml" },
  { name: "Yogur natural Alpura", carbsPer100g: 6, source: "local", category: "Lácteos", unit: "ml" },
  { name: "Yogur endulzado Yoplait", carbsPer100g: 17, source: "local", category: "Lácteos", unit: "ml" },
  ...
  { name: "Crema ácida", carbsPer100g: 3, source: "local", category: "Lácteos", unit: "ml" },
  ...
  { name: "Jugo de naranja natural", carbsPer100g: 10, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Jugo Jumex naranja", carbsPer100g: 12, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Agua de jamaica", carbsPer100g: 8, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Agua de horchata", carbsPer100g: 16, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Agua de tamarindo", carbsPer100g: 14, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Coca-Cola regular", carbsPer100g: 11, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Pepsi regular", carbsPer100g: 11, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Jarrito de mandarina", carbsPer100g: 12, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Limonada con azúcar", carbsPer100g: 9, source: "local", category: "Bebidas", unit: "ml" },
  { name: "Leche Milo", carbsPer100g: 14, source: "local", category: "Bebidas", unit: "ml" },
